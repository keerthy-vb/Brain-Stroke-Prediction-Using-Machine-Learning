...
Original file is located at
    https://colab.research.google.com/drive/1hjhwq0aP1TXDXTEq6DH49UBnr_DxYw7g
"""
...
rf.fit(x_train, y_train['stroke'].values.ravel())

accuracy = rf.score(x_test, y_test['stroke'].values.ravel())
